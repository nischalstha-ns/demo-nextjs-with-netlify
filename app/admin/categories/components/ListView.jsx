...
export default function ListView() {
    ...
    return (
        <div className="align-center flex-1 flex flex-col gap-3 px-5 rounded-xl">
            <h1 className="text-xl"><b>Categories</b></h1>
...
<th className="font-semibold border-y border-r bg-white px-4 py-3 rounded-r-lg text-center">
    Action
</th>
                    </tr>
                </thead>
